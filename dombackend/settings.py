"""
Django settings for dombackend project.
...
SECRET_KEY = 'django-insecure-9gmbm=1*gw9toywj!m6sh04&qv(%=_x!y)09d8al3rol+^cr%('
...
WSGI_APPLICATION = 'dombackend.wsgi.application'
